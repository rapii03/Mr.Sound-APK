...
const AnNas = ({ route, navigation, playbackObj }) => {
    ...
    async function playSound() {
        ...
        const { sound } = await Audio.Sound.createAsync(require('../../assets/Lagu//AnNas.mp3')
        );
        setSound(sound);
            ...
            <View style={styles.container}>
                ...
                <View style={styles.column}>
                    ...
                    <Text style={styles.kanan}>
                        <TouchableOpacity onPress={() => navigation.navigate('InfoAnNas')}><Icon name="info-circle" size={20} color="#000000" />
                        ...
                        <View style={styles.row}>
                            <View style={styles.columnMusik}>
                                <View style={styles.infoMusik}>
                                    <Text style={styles.namaMusik} >An-Nas</Text>
