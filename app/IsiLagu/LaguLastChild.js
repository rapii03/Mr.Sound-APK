...
const LaguLastChild = ({ route, navigation, playbackObj }) => {
    // Aawal
    const [sound, setSound] = React.useState();

    async function playSound() {
        console.log('Loading Sound');
        const { sound } = await Audio.Sound.createAsync(require('../../assets/Lagu/LastChild_Pedih.mp3')
        );
        setSound(sound);
            ...
            <View style={styles.container}>
                ...
                <View style={styles.column}>
                    ...
                    <Text style={styles.kanan}>
                        <TouchableOpacity onPress={() => navigation.navigate('InfoLaguLastChild')}><Icon name="info-circle" size={20} color="#000000" />
                        ...
                        <View style={styles.row}>
                            <View style={styles.columnMusik}>
                                <View style={styles.infoMusik}>
                                    <Text style={styles.namaMusik} >Last Child Pedih</Text>
