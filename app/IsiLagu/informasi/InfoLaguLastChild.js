...
const InfoLaguLastChild = ({ route, navigation, playbackObj }) => {
    ...
    return (
        <ScrollView>
            ...
            <View style={styles.containerIsi}>
                <Text style={styles.containerIsiTeks}>Last Child adalah sebuah grup musik asal Indonesia yang terbentuk pada tahun 2006. Grup musik ini terdiri dari Enno (drum), Dhimaz (gitar), Virgoun (vokal), dan Nanda (bass). Last Child dikenal dengan lagu-lagu mereka yang catchy dan lirik yang bercerita tentang percintaan, persahabatan, dan kehidupan sehari-hari.
Last Child sering dianggap sebagai salah satu grup musik pop rock Indonesia yang sukses dan populer. Mereka telah menerima banyak penghargaan dan nominasi di berbagai ajang musik Indonesia, termasuk Anugerah Musik Indonesia (AMI) dan Dahsyatnya Awards. Karya-karya Last Child juga telah banyak diakui oleh masyarakat Indonesia dan menjadi bagian dari sejarah musik Indonesia.</Text>
...
export default InfoLaguLastChild