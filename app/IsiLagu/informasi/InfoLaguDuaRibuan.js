...
const InfoLaguDuaRibuan = ({ route, navigation, playbackObj }) => {
    ...
    return (
        <ScrollView>
            ...
            <View style={styles.containerIsi}>
                <Text style={styles.containerIsiTeks}>Musik pop Indonesia adalah genre musik yang berasal dari Indonesia dan terinspirasi oleh musik pop Barat. Musik pop Indonesia umumnya menggunakan instrumen modern seperti gitar listrik, bass, drum, dan keyboard, serta vokal yang didominasi oleh penyanyi solo atau grup vokal. Lirik lagu pop Indonesia seringkali mengangkat tema-tema percintaan, kehidupan sehari-hari, persahabatan, atau aspirasi dan harapan.
                    Secara keseluruhan, musik pop Indonesia pada era 2000-an menampilkan beragam gaya musik dan lirik yang mengangkat tema-tema cinta, persahabatan, dan kehidupan sehari-hari dengan aransemen musik yang modern dan catchy.</Text>
...
export default InfoLaguDuaRibuan