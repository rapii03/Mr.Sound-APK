...
const InfoLaguIndie = ({ route, navigation, playbackObj }) => {
    ...
    return (
        <ScrollView>
            ...
            <View style={styles.containerIsi}>
                <Text style={styles.containerIsiTeks}>Di Indonesia, musik indie mulai populer sejak awal 2000-an dengan munculnya berbagai grup musik indie seperti Efek Rumah Kaca, Sore, Payung Teduh, dan Tulus. Musik indie Indonesia telah menjadi sebuah gerakan yang kuat dalam industri musik Indonesia dan telah membuka banyak peluang bagi para musisi independen untuk mengekspresikan kreativitas mereka secara bebas.</Text>
