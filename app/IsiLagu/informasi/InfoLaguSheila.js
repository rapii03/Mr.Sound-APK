...
const InfoLaguSheila = ({ route, navigation, playbackObj }) => {
    ...
    return (
        <ScrollView>
            ...
            <View style={styles.containerIsi}>
                <Text style={styles.containerIsiTeks}>Sheila On 7 adalah grup musik asal Indonesia yang terbentuk pada tahun 1996. Grup musik ini terdiri dari Duta (vokal), Eross (gitar), Adam (bass), dan Brian (drum). Sheila On 7 dikenal dengan musik pop rock dan lagu-lagu mereka yang catchy dengan lirik yang mudah dicerna oleh masyarakat Indonesia.
Setelah merilis album perdana, Sheila On 7 terus aktif merilis album dan singel-singel terbaru. Beberapa lagu hits Sheila On 7 yang populer di kalangan masyarakat Indonesia adalah "Berhenti Berharap", "Melompat Lebih Tinggi", "Pemuja Rahasia", dan "Itu Aku". Sheila On 7 juga kerap tampil dalam konser musik dan acara televisi di Indonesia.</Text>
