...
const InfoLaguVierra = ({ route, navigation, playbackObj }) => {
    ...
    return (
        <ScrollView>
            ...
            <View style={styles.containerIsi}>
                <Text style={styles.containerIsiTeks}>Vierra adalah sebuah grup musik pop Indonesia yang dibentuk pada tahun 2008. Grup musik ini terdiri dari Widy (vokal), Raka (gitar), Dey (bass), dan Kevin (drum). Vierra dikenal dengan lagu-lagu mereka yang easy listening dengan lirik yang romantis dan ceria.
Vierra merilis album perdana mereka, yang bertajuk "My First Love", pada tahun 2009. Album ini berisi lagu-lagu seperti "Seandainya", "Dengarkan Curhatku", dan "Rasa Ini". Lagu-lagu ini menjadi populer di Indonesia dan membawa Vierra meraih kesuksesan di industri musik Indonesia.</Text>
