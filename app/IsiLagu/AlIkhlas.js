...
import InfoAlIkhlas from './informasi/InfoAlIkhlas';
...
const AlIkhlas = ({ route, navigation, playbackObj }) => {
    ...
    async function playSound() {
        ...
        const { sound } = await Audio.Sound.createAsync(require('../../assets/Lagu/AlIkhlas.mp3')
        );
        setSound(sound);
            ...
            <View style={styles.container}>
                ...
                <View style={styles.column}>
                    ...
                    <Text style={styles.kanan}>
                        <TouchableOpacity onPress={() => navigation.navigate('InfoAlIkhlas')}><Icon name="info-circle" size={20} color="#000000" />
                        ...
                        <View style={styles.row}>
                            <View style={styles.columnMusik}>
                                <View style={styles.infoMusik}>
                                    <Text style={styles.namaMusik} >Al-Ikhlas</Text>
