...
import InfoAlFatihah from './informasi/InfoAlFatihah';
...
const AlFatihah = ({ route, navigation, playbackObj }) => {
...
// Aawal
    ...
    async function playSound() {
        ...
        const { sound } = await Audio.Sound.createAsync(require('../../assets/Lagu/AlFatihah.mp3')
        );
        setSound(sound);
            ...
            <View style={styles.container}>
                ...
                <View style={styles.column}>
                    ...
                    <Text style={styles.kanan}>
                        <TouchableOpacity onPress={() => navigation.navigate('InfoAlFatihah')}><Icon name="info-circle" size={20} color="#000000" />
                        </TouchableOpacity>
                    </Text>
                </View>
                        ...
                        <View style={styles.row}>
                            <View style={styles.columnMusik}>
                                <View style={styles.infoMusik}>
                                    <Text style={styles.namaMusik} >Al-Fatihah</Text>
